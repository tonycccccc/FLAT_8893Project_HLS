...
void FlatDataflow(
        data_t query[1][64][16][64],
        data_t key[1][64][16][64],
        //data_t value[1][64][16][64],
        data_t bias[1][16][64][64],
        data_t logit_out[1][16][64][64]
)
{
//--------------------------------------------------------------------------
...
#pragma HLS INTERFACE m_axi depth=576*16*64*64  port=logit_out  bundle=Attentin_out
...
#pragma HLS INTERFACE s_axilite register    port=return
    ...
    main_loop: for (int idx = 0; idx < (BATCH_B); ++idx) //576 batches in total
    {
        ...
        //Save_Partial_Output();
        Store_Output_to_DRAM(Logit_out_buffer, logit_out, idx);
